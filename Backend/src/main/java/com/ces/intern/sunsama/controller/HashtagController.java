...
public class HashtagController {
    ...
    @GetMapping("/{id}")
    public HashtagResponse getHashtagById(@PathVariable long id){
        HashtagDTO hashtag = hashtagService.getHashtagById(id);
        return modelMapper.map(hashtag, HashtagResponse.class);
    }
